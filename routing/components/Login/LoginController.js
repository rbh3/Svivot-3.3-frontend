...
.controller('LoginController', ['$http','$scope','$location','setHeadersToken','localStorageModel','$rootScope',function($http,$scope,$location,setHeadersToken,localStorageModel,$rootScope) {
  let self=this;
